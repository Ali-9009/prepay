        ...
        <>
            ...
            <div className="p-6 space-y-6">
                <div className="flex flex-col sm:flex-row items-stretch justify-center gap-4">
                    <div
                        onClick={() => next(undefined, "transfer")}
                        className="flex-1 cursor-pointer"
                    >
                        <div className="h-full border-2 border-gray-200 rounded-xl p-5 flex flex-col items-center text-center transition hover:border-red-500 hover:shadow-md">
