        ...
        <section className="py-12 min-h-screen">
            <div className="max-w-4xl mx-auto px-6">
                ...
                <div className="text-gray-700 text-lg space-y-6 leading-relaxed">
                    ...
                    <p>
                        You understand that your content (not including credit/debit card
                        information), may be transferred unencrypted and involve (a)
                        transmissions over various networks; and (b) changes to conform and
                        adapt to technical requirements of connecting networks or devices.
                        credit/debit card information is always encrypted during transfer
                        over networks.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        credit/debit card, and/or orders that use the same billing and/or
                    ...
                    <p>
                        ...
                        your email address and credit/debit card numbers and expiration
                    ...
                    <p>
                        In no case shall Hello PrePay, our directors, officers, employees,
                    ...
                    <p>
                        You agree to indemnify, defend and hold harmless Hello PrePay and
                    ...
                    <p>
                        ...
                        accordance with the laws of the state of Florida, Miami Dade County,
                        U.S.A.
                    </p>
                    ...
                    <p>
                        This website is operated by Hello PrePay. Throughout the site, the
                        terms "we", "us" and "our" refer to Hello PrePay. Hello PrePay
                    ...
                    <p>
                        Our store is hosted using Cloudway LTD using WordPress CMS and
                        WooCommerce Shopping cart. WordPress and WooCommerce provides us
