    ...
    <>
      ...
      <div className="bg-(--primary-color) p-6 relative flex flex-col items-center text-center">
        ...
        <p className="text-white text-sm mt-1 max-w-md">
          This is typically your home or school address. This is used to set your area code
          and enable quick 911 location. The address must be a valid U.S. address.
        </p>
      </div>
      ...
      <div className="p-6 space-y-6">
        ...
        >
          ...
          <Button type="submit" className="w-full text-center" text="Continue" onClick={() => next(2)} />
        </form>
