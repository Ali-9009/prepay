...
function Footer() {
  ...
  return (
    <footer className="bg-white border-t border-[#eee]  ">
      <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 pt-12 pb-6 px-6 md:px-20">
        ...
        <div>
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              <Phone fill="currentcolor" stroke="none" size={16} className="text-(--primary-color) shrink-0" />
              (786) 884-2070
            </a>
            <a
              ...
              className="flex items-center gap-2 text-[#111] text-sm no-underline hover:text-(--primary-color) transition-colors"
            >
              <i className="ri-mail-fill text-(--primary-color)"></i>
